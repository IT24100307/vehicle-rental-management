document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleDiscountFormSubmit(event) {
        ...
        const discount = {
            ...
            staffId: document.getElementById('staffId').value // Get selected staff ID
        };
    ...
    function renderDiscountCards(discounts) {
      ...
      function createDiscountCardHtml(discount) {
        ...
        let staffInfo = '';
        if (discount.staffId) {
            // We'll fetch and display staff info in a separate function
            staffInfo = `<p class="mt-2 text-muted"><i class="fas fa-user-tie"></i> Staff ID: ${discount.staffId}</p>`;
        }
                ...
                <div class="card discount-card ${discount.active ? '' : 'bg-light text-muted'}">
                    <div class="card-body position-relative">
                        ...
                        <h5 class="card-title mt-4">
                            ...
                            ${discount.name}
                        </h5>                        <p class="card-text">${discount.description}</p>
                        ${dateInfo}
                        ${minimumRidesInfo}
    ...
    function editDiscount(discount) {
        ...
        document.getElementById('staffId').value = discount.staffId || ''; // Set staff ID
    ...
    function loadStaffMembers() {
        ...
        fetch('/api/discounts/staff')
            ...
            .then(staffMembers => {
                ...
                const defaultOption = staffIdSelect.options[0];
                staffIdSelect.innerHTML = '';
                staffIdSelect.appendChild(defaultOption);
                
                // Add staff options to select
            ...
            .catch(error => {
                ...
                showToast('Error', 'Failed to load staff members. Please refresh the page.', true);
            });
    }
});