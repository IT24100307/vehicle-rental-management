...
function initRentalDetailsModal() {
    ...
    returnButton.addEventListener('click', async function() {
        ...
        try {
            ...
            // Call the API to return the vehicle using apiRequest instead of fetch directly
            const data = await apiRequest(`/customers/rental/${selectedRental.purchaseId}/return`, 'POST');
            
            // Log the response for debugging
            console.log('Return vehicle response:', data);
